...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_DVORAK] = LAYOUT(
		...
		MO(_FUNC),         KC_LGUI, KC_LALT,         KC_SPC, KC_RCTL,          KC_LSFT,    KC_SPC,  CH_JP,   MO(_FUNC),  KC_RCTL, KC_LEFT,  KC_DOWN, KC_RGHT),
 [_NICOLA] = LAYOUT(
		KC_ESC,  KC_F1,   KC_F2,  KC_F3,  KC_F4,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  KC_DEL,  KC_PSCR,
		...
		X__X ,   NG_A,    NG_S,   NG_D,   NG_F,   NG_G,    KC_BSPC, NG_H,    NG_J,    NG_K,    NG_L,     NG_SCLN, KC_BSPC, KC_ENT,           KC_PGDN,
		X__X,    NG_Z,    NG_X,   NG_C,   NG_V,   NG_B,    KC_ENT,  NG_N,    NG_M,    NG_COMM, NG_DOT,   NG_SLSH, KC_RSFT, KC_UP,
		X__X,    X__X  ,  KC_LALT,KC_SPC, NG_SHFTL,                 NG_SHFTR,VI_MODE, X__X, MO(_FUNC),KC_RCTL, KC_LEFT,KC_DOWN, KC_RGHT),
 [_VI] = LAYOUT(
  ...
  [_FUNC] = LAYOUT(
    ...
    X__X,  ,C(KC_A),C(KC_S),  X__X ,C(KC_F),  X__X,   X__X,  X__X,  X__X,  X__X,   X__X,   X__X,   X__X,   X__X,           KC_END,
    KC_LSFT ,C(KC_Z),C(KC_X),C(KC_C),C(KC_V)  X__X,   X__X,  X__X,  X__X,  X__X,   X__X,   X__X,   KC_MUTE,KC_VOLU,
